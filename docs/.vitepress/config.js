    ...
    themeConfig: {
        sidebar: [
            ...
            },
            {
                text: 'JavaScript',
                items: [
                    { text: 'defineProperty 详细解读', link: '/JavaScript/101' },
                    { text: 'JavaScript 对象解读', link: '/JavaScript/102' },
                    { text: 'JavaScript 的对象与继承', link: '/JavaScript/103' },
                    { text: 'JavaScript 异步与 Promise', link: '/JavaScript/104' },
                    { text: 'JavaScript 正则理解', link: '/JavaScript/105' },
                    { text: '周下载量超1亿的库是如何判断JS类型的？', link: '/JavaScript/106' },
